<?php require_once 'header-product.php'; ?>
		...
		<section class="products-tabs">
			...
			<div class="products-tabs__items">
				<div class="section-container">
					...
					<div id="tab-3" class="tab-content current products-tabs__item">
						<div class="products-tabs__item-left">
		...
		<section class="characteristics">
			<div class="section-container">
				<div class="characteristics-title">
					Все характеристики самогонного аппарата «Малиновка» Щукина PRO
				</div>
		...
		<section class="present schukina-pro">
			<div class="section-container">
