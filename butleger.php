...
<head>
	...
	<title>Малиновка Бутлегер</title> 
</head>
<body>
				...
				<div class="characteristics__container">
					<div class="characteristics__slider">
						<div class="characteristics__slider-item">
							<div class="characteristics__slider-img" style="background: url(../img/options/1b.jpg) no-repeat 0 0">
							</div>
							<div class="characteristics__slider-content">
								<div class="characteristics__slider-title">
									БОЛЬШАЯ УДОБНАЯ ГОРЛОВИНА
								</div>
								<div class="characterictics__slider-text">
									Достаточно широкая горловина, полностью решена проблема заливки браги, очистки. Благодаря горловине, которая находится в центре бака - сливает оставшуюся часть сырья после перегонки.
								</div>
						...
						<div class="characteristics__slider-item">
							<div class="characteristics__slider-img" style="background: url(../img/options/20b.jpg) no-repeat 0 0">
							</div>
							<div class="characteristics__slider-content">
								<div class="characteristics__slider-title">
									ДВОЙНАЯ ПЕРЕГОНКА И РАЗБОРНАЯ КОНСТРУКЦИЯ
								</div>
								<div class="characterictics__slider-text">
									Можно использовать аппарат как с двойной перегонкой, так и с одной. Модернизация до ректификационной колонны с помощью установки царги и дефлегматора.
									Имеется доступ к первому баку, за счет извлечения второго куба, теперь вы легко можете промывать оба куба за счет большой горловины.
								</div>
								<div class="characterictics__slider-buttons">
									<a href="#write-form" class="open-popup-link more">Получить консультацию</a>
									<a href="#product-order-form-kapitan" class="buy open-popup-link">Купить</a>
						...
						<div class="characteristics__slider-item">
							<div class="characteristics__slider-img" style="background: url(../img/options/3b.jpg) no-repeat 0 0">
							</div>
							<div class="characteristics__slider-content">
								<div class="characteristics__slider-title">
									УНИВЕРСАЛЬНОСТЬ
								...
								<div class="characterictics__slider-text">
									Возможность модернизации до бражной колонны с помощью установки ДИОПТРИЯ и царги любой длинны. Теперь вы сможете забыть о порезах рук, закусывании резьбы и прочих недостатках резьбовых соединений.
								</div>
								<div class="characterictics__slider-buttons">
									<a href="#write-form" class="open-popup-link more">Получить консультацию</a>
									<a href="#product-order-form-kapitan" class="buy open-popup-link">Купить</a>
						...
						<div class="characteristics__slider-item">
							<div class="characteristics__slider-img" style="background: url(../img/options/4b.jpg) no-repeat 0 0">
							</div>
							<div class="characteristics__slider-content">
								<div class="characteristics__slider-title">
									ДИОПТРИЙ И КЛАМПОВОЕ СОЕДИНЕНИЕ
								</div>
								<div class="characterictics__slider-text">
									С помощью клампового соединения появилась возможность установки ДИОПТРИЯ, теперь вы сможете контролировать весь процесс  и видеть его (как происходит химический процесс).
								</div>
								<div class="characterictics__slider-buttons">
									<a href="#write-form" class="open-popup-link more">Получить консультацию</a>
									<a href="#product-order-form-kapitan" class="buy open-popup-link">Купить</a>
						...
						<div class="characteristics__slider-item">
							<div class="characteristics__slider-img" style="background: url(../img/options/5b.jpg) no-repeat 0 0">
							</div>
							<div class="characteristics__slider-content">
								<div class="characteristics__slider-title">
									ВНЕШНИЙ ВИД
								...
								<div class="characterictics__slider-text">
									Качество всех сварных швов на поверхности изделия остается очень высоким за счет автоматического роботизированного оборудования.
								</div>
								<div class="characterictics__slider-buttons">
									<a href="#write-form" class="open-popup-link more">Получить консультацию</a>
									<a href="#product-order-form-kapitan" class="buy open-popup-link">Купить</a>
						...
						<div class="characteristics__slider-item">
							<div class="characteristics__slider-img" style="background: url(../img/options/6b.jpg) no-repeat 0 0">
							</div>
							<div class="characteristics__slider-content">
								<div class="characteristics__slider-title">
									ПЛОСКОЕ ДНО
								...
								<div class="characterictics__slider-text">
									100% прилегание дна к нагревающей поверхности, работает на всех видах плит.
									Второй куб расположен максимально близко ко дну - это позволяет улучшить нагрев и этим влияя на скорость перегонки и получение более качественного напитка.
								</div>
								<div class="characterictics__slider-buttons">
									<a href="#write-form" class="open-popup-link more">Получить консультацию</a>
									<a href="#product-order-form-kapitan" class="buy open-popup-link">Купить</a>
						...
						<div class="characteristics__slider-item">
							<div class="characteristics__slider-img" style="background: url(../img/options/7b.jpg) no-repeat 0 0">
							</div>
							<div class="characteristics__slider-content">
								<div class="characteristics__slider-title">
								...
								<div class="characterictics__slider-text">
									Все самогонные аппараты «МАЛИНОВКА» БУТЛЕГЕР оснащаются прокладками из пищевого термостойкого медицинского силикона. Благодаря этому и обеспечивается надежная герметизация устройства, а ваш конечный продукт будет без постороннего запаха.
								</div>
								<div class="characterictics__slider-buttons">
									<a href="#write-form" class="open-popup-link more">Получить консультацию</a>
									<a href="#product-order-form-kapitan" class="buy open-popup-link">Купить</a>
